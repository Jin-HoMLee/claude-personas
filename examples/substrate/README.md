...
- Yes - multi-repo endeavor, or multiple concurrent role sessions: use the role-clones topology (`framework/tools/init-clone.sh` and a separate memory repo) instead.
